                ...
                {isRecruitsLoading ? (
                  ...
                  myRecruits.recruits.map((project: any) => (
                    <article
                      ...
                      className="cursor-pointer rounded-[14px] border border-[#E2E8F0] bg-white px-[16px] py-[14px] shadow-[0_2px_8px_rgba(15,23,42,0.06)] transition active:scale-[0.99]"
                    >
                      <div className="flex items-start justify-between gap-[12px]">
                ...
                {isParticipatingRecruitsLoading ? (
                  ...
                  participatingRecruits.recruits.map((project: any) => (
                    <article
                      ...
                      className="cursor-pointer rounded-[14px] border border-[#E2E8F0] bg-white px-[20px] py-[18px] shadow-[0_2px_8px_rgba(15,23,42,0.06)] transition active:scale-[0.99]"
                    >
                      <div className="flex items-start justify-between gap-[12px]">
                        <div className="min-w-0 flex-1">
                          <h3 className="truncate text-[15px] font-bold leading-[24px] text-[#1E293B]">
